...
class Auto
{
    ...
    public static function update($object)
    {
        if (!Auto::isValidUnique($object->patente)) {
            ...
            foreach ($archivoArray as $datos) {
                $nuevoAuto = new Auto($datos->patente, $datos->date, $datos->email, $datos->fecha_egreso, $datos->importe);
    ...
    public static function sumAllByType($tipo)
    {
        ...
        foreach ($archivoArray as $datos) {
            $nuevoAuto = new Auto($datos->patente, $datos->tipo, $datos->email, $datos->fecha_egreso, $datos->importe);
    ...
    public static function getByPatente($patente)
    {
        ...
        foreach ($archivoArray as $datos) {
            $nuevoAuto = new Auto($datos->patente, $datos->date, $datos->email);
